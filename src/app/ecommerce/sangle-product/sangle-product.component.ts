...
import { User, ProductOrder, Product, Tag, Cart, ProductOrders, UpdateProduct,Comment } from 'src/app/modal/modal.service';
...
export class SangleProductComponent implements OnInit {
  ...
  shoppingCartOrders: ProductOrders = new ProductOrders;
  sub!: Subscription;
  ...
  removeFromCart(productOrder: ProductOrder, idUser: any ) {
