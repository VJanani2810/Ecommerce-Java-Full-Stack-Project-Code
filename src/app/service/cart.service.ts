...
import { Cart } from '../modal/modal.service';
...
export class CartService {
  ...
  findCartsForUser(idUser: number | undefined): Observable<Cart[]> { // jc add undefined
  ...
  getCartName(): string {
    return sessionStorage.getItem(NAME_KEY) as string; // jc add
  }
}